      ...
      <div className="mainLogin">
          ...
          <section className="formContent">
            <div className="mainform">
              <div className="headerForm">
                <h1 className="titleForm">Registrate</h1>
                <span className="spanForm">Ingresa los datos necesarios</span>
              </div>

              <div className="formContainer">
                <form onSubmit={onRegister} className="formLogin">
              ...
              <div className="footerForm">
                <span className="footerForm">Otras opciones</span>
        ...
        <section className="sectionShow">
          <div className="showContent">
            <h3>¡Descubre un mundo de aprendizaje! ¡Registrate ahora!</h3>
